...
export default function DiplomadoCard({ title, description, href, src }: DiplomadoCardProps) {
  return (
    <Link href={`/diplomados/${href}`} className="flex flex-col items-start gap-4">
