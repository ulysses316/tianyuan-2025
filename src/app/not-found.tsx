...
export default function Custom404() {
  return (
    <>
      <div className="absolute top-0 -z-10 h-28 w-screen bg-black/40" />
      <div className="flex h-screen w-screen items-center justify-center">
        <div className="container flex flex-col items-center justify-center px-5 md:flex-row">
          <div className="max-w-md">
            ...
            <p className="mb-8">Pero no te preocupes, en nuestra página de inicio podrás encontrar muchas más cosas.</p>
            <Button href="/">Regresa al inicio</Button>
          </div>
